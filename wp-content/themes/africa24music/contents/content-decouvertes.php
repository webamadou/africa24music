<?php
/**
 * Lis of videos in the category decouverte
 */
?>
<div class="col-xs-12 col-sm-6 col-md-3">
	<div class="video-item-cadre">
		...
		<div class="plays">
			<span class="play-btn"><img src="<?php echo get_template_directory_uri() ?>/images/play-icon.png" class="img-responsive" alt="africa24music-play-btn" title="africa24music-play-btn" ></span>
		</div>
