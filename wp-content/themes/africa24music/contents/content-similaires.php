<li class="col-xs-12 col-sm-6 col-md-3 video">
	<div class="video-item-cadre">
		<span class="video-tags">
			<span class="views"><i class="a24-eye2"></i> <?php echo wpb_get_videos_views(get_the_ID()); ?></span>
		...
		<div class="video-item"><img src="<?php echo the_post_thumbnail_url('small'); ?>" class="img-responsive" alt="<?php echo 'africa24music-'.get_the_title(); ?>" title="<?php echo get_the_title(); ?>"></div>
