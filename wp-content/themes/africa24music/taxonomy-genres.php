...
<div class="container">
    <div class="cadre"> <!-- cadre contenu des pages: mettre le contenu des pages à partir d'ici -->
    	<div class="page-content">
    		...
    		<h1 class="page-title tag-title"> <?php echo $name ?></h1>
    			...
    			<div class="filter-order">
    				...
    				<div class="col-xs-12 col-sm-6 order-menu">
    					<div class="order">
                            ...
                            <input type="hidden" name="post_type" value="a24videos" />    					</div>
    				</div>
    			</div>
...
<!--     			<div class="col-xs-12 col-sm-6 col-md-3 shuffle_sizer"></div>
 -->    		</div>
                ...
                <div class="see-more"><a class="videos-load-more" data-page="1" data-url="<?php echo admin_url('admin-ajax.php'); ?>" data-tax="genres" data-slug="<?php echo $slug; ?>">voir plus</a></div>  
    	</div>
    </div>
</div>
<?php get_footer() ?>