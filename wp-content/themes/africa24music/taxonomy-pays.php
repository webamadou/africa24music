...
<!--     			<div class="col-xs-12 col-sm-6 col-md-3 shuffle_sizer"></div>
 -->    		</div>
                ...
                <div class="see-more"><a class="videos-load-more" data-page="1" data-url="<?php echo admin_url('admin-ajax.php'); ?>" data-tax="pays" data-slug="<?php echo $slug; ?>">voir plus</a></div>  
