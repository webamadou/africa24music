...
<div class="container">
    <div class="cadre"> <!-- cadre contenu des pages: mettre le contenu des pages à partir d'ici -->
    	<div class="page-content"><br>
            ...
            <h1 class="page-title no-margin tag-title"> <?php echo $name ?></h1>
    		...
    		<div id="timeline" class="row home-timeline active videos-container">
                <?php
                    $args = array('post_type' => 'a24videos',
                                  'order' => 'DESC',
                                  'tax_query' => array(array('taxonomy' => 'video_tags',
                                                             'field'    => 'slug',
                                                             'terms'    => $slug,
                                                            ))
                                  );
...
<!--     			<div class="col-xs-12 col-sm-6 col-md-3 shuffle_sizer"></div>
 -->    		</div>
                ...
                <div class="see-more"><a class="videos-load-more" data-page="1" data-url="<?php echo admin_url('admin-ajax.php'); ?>" data-tax="video_tags" data-slug="<?php echo $slug; ?>">voir plus</a></div>  
